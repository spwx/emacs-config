...
(use-package general
  ...
  (my/leader-keys
    ...
    "sM" '(consult-global-mark :wk "Global marks")
...
(my/leader-keys "by" '(copy-buffer-file-path :wk "Copy path"))
...
(my/leader-keys "bD" '(delete-this-file :wk "Delete file"))
(my/leader-keys "bR" '(revert-buffer-quick :wk "Reload file"))
